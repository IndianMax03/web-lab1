...
//             Document methods
    ...
    , ["getElementsByClassName", "определитьКрестьянинаПоОбщине"]
    , ["getElementsByTagName", "вычислитьТерпилПоТегу"]
    , ["importNode", "влабазУзел"]
    , ["registerElement", "зашитьДело"]
    , ["releaseCapture", "зафотатьХуякХуяк"]
    , ["getElementById", "определитьКрестьянинаПоПашпорту"]
    , ["querySelector", "пойматьРаспутницу"]
...
//            Window properties
    ...
    , ["top", "КрышаЙбать"]
//            Window methods
    , ["addEventListener", "приставитьСтражу"]
    , ["checked", "числится"]
    , ["alert", "шухер"]
    , ["blur", "размытьЕбало"]
